...
if not st.session_state.logged_in:
    ...
    page_4 = st.Page("pages/Contact Us.py" , title="Contact Us", icon=":material/view_timeline:")
    page_5 = st.Page("pages/Order Renew.py", title="Order Renew", icon=":material/view_timeline:")
