...
if not st.session_state.logged_in:
    ...
    page_4 = st.Page("pages/Order Renew.py", title="Order Renew", icon=":material/autorenew:")
    page_5 = st.Page("pages/Contact Us.py" , title="Contact Us", icon=":material/contact_support:")
